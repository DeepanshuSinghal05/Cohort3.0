  ...
  return (
    <div className="max-w-sm overflow-hidden rounded-2xl bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-gray-200">
      ...
      <div className="p-5">
        ...
        {/* Button */}
        <button onClick={()=>setCartItems((prev)=>[...prev, product])} className="mt-5 w-full rounded-xl bg-black py-3 font-semibold text-white transition-all duration-300 hover:bg-gray-800 hover:shadow-lg">
          Add to Cart
        </button>
      </div>
    </div>
